 ...
 * VacunaUser
 *
 * @ORM\Table(name="vacunauser")
 * @ORM\Entity
 */
class VacunaUser implements \JsonSerializable
{
     ...
     */
    public function __construct(string $name, bool $twoMonths, bool $fourMonths, bool $elevenMonths, bool $twelveMonths, bool $fifteenMonths, bool $fourYears, bool $sixYears, bool $twelveYears, bool $fourteenYears)
    {
        $this->name = $name;
